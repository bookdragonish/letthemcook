...
## About our project
This project was a group project that was part of the course IT2810 on NTNU. 

It is hosted on NTNUs subdomain assigned to our group that can be reached while being connected to **eduroam** or **NTNU VPN**. If you have access to these the link to the project is:
[it2810-02.idi.ntnu.no/project2/](http://it2810-02.idi.ntnu.no/project2/)

*The project is not yet hosted on a public link, but will be in the future*

### The front page:
<img width="1343" height="901" alt="image" src="https://github.com/user-attachments/assets/7ccc946a-ec9e-4d6f-bac8-1cbb3f8be126" />

## Collaborators

Our team consisted of four informatics students, however the code posted here was made only by another teammember Gina Giske and Me.
...
### Testing
It is written end to end tests, component tests and backend tests for the project. More information about all of these types of tests can be found in the [release](./docs/release4.md#code-quality) file.
